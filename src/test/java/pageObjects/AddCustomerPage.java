...
public class AddCustomerPage extends BaseClass {
    ...
    //instaed @find we qwill use defferent approach
    //another approach of creating page objext
    ...
    By btnSave = By.xpath("//button[@ame='save']");
    ...
    public void setCustomerRoles(String role) throws InterruptedException {
        if (!role.equals("Vendors")) //If role is vendors should not delete Register as per logic
        {
